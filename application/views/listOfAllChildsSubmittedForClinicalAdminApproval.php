    ...
    <body>
        ...
        <div class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            ...
            <div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center ">
                <h1 class=" h2 text-white">Pending Supervision</h1>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <h4 class='my-3'>List of children submitted for clinical admin approval</h4>
                            ...
                            <tbody>
                                <?php foreach ($childrendata as $index => $child) { ?>
                                    <tr>
                                        ...
                                        <td><a class="nav-link" href="<?php echo base_url('index.php/Home/childScreeningQuestionsAnswer/' . $child['child_id']) ?>">View Screening Details </a></td>
                                    </tr>
                                <?php } ?>
