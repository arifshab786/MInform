...
<head>
    ...
    <title>create health worker</title>
</head>
...
<body>
    <div class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center ">
            <h1 class=" h2 text-white">Create Health Worker</h1>
        </div>
            ...
            <div>
                ...
                <div class="row popup">
                    ...
                    <div class="right col rounded">
                        ...
                        <h1 class='text-center mt-3'>Register Health Worker</h1>
                        <form class='mt-5 ml-4' method='post' name='login' action='<?php echo base_url() . 'index.php/Home/createHealthWorker'; ?>'>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="form-group mx-4">
                                    <label>Address</label>
                                    <input type="text-area" name="address" class="form-control" placeholder="address">
                                </div>
                                <div class="form-group mx-5">
                            ...
                            <div class="form-group mx-4 mr-5">
                                <label>Select Area</label>
                                <select class="form-control mr-5" name="area" aria-label="Default select example">
                                    <option class="form-control" hidden>Open this select menu</option>
                                    <?php
