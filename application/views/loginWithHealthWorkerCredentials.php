...
<html lang="en">
  <head>
    ...
    <title>Login With Health Worker Credentials</title>
  </head>
  <body>
    <div class="container mb-4">
        ...
        <div class="row popup">
            ...
            <div class="right col rounded">
                ...
                <h1 class='text-center mt-3'>Health Worker Login</h1>
                <form class='mt-5' method='post' name='login' action='<?php echo base_url().'index.php/Home/loginWithHealthWorkerCredentials'; ?>'>
